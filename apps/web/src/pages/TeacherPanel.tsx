      ...
      <section className="space-y-4 rounded-3xl border border-white/10 bg-white/5 p-5">
        ...
        <div className="flex flex-wrap gap-2 text-sm">
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/10 px-3 py-2 transition hover:bg-white/15"
            type="button"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-red-400/40 bg-red-500/10 px-3 py-2 text-red-200 transition hover:bg-red-500/20"
            type="button"
          >
          ...
          {groups.map((group) => (
            <li key={group.id} className="flex items-center justify-between rounded-xl border border-white/10 bg-[#0f0f0f] px-3 py-2">
              ...
              <button
                ...
                className="rounded-lg border border-white/10 bg-white/10 p-2 transition hover:bg-white/15"
                type="button"
              >
            ...
            <li key={student.id} className="flex items-center justify-between py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-lg border border-white/10 bg-white/10 p-2 text-xs text-white/70 transition hover:bg-white/15"
                  type="button"
                  title="Ban"
                >
                ...
                <button
                  ...
                  className="rounded-lg border border-white/10 bg-red-500/10 p-2 text-xs text-red-200 transition hover:bg-red-500/20"
                  type="button"
                  title="O‘chirish"
                >
